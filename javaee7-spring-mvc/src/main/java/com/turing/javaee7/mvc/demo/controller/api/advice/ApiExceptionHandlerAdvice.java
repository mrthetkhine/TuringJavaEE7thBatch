package com.turing.javaee7.mvc.demo.controller.api.advice;
...
import com.turing.javaee7.mvc.demo.controller.api.dto.ApiError;
import com.turing.javaee7.mvc.demo.controller.api.dto.ErrorCode;
...
public class ApiExceptionHandlerAdvice{
    ...
    public ResponseEntity<Object> handleNotFoundException(NotFoundException ne) {
        ...
        ApiError apiError = 
  		      new ApiError(HttpStatus.NOT_FOUND, ErrorCode.INVALID_BOOK_ID.toString(), ne.getLocalizedMessage(), error);
    ...
    public ResponseEntity<Object> handleBeanValidationError(BeanValidationException be) {
        ...
        ApiError apiError = 
  		      new ApiError(HttpStatus.BAD_REQUEST, ErrorCode.BEAN_VALIDATION_ERROR.toString(), be.getLocalizedMessage(), errorMessage);
  		    return new ResponseEntity<Object>(
  		      apiError, new HttpHeaders(), apiError.getStatus());
    }
}
